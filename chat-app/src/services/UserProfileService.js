...
export const saveUserInfo = async (userData) => {
  try {
    ...
    if (querySnapshot.size === 0) {
      ...
      console.log("Lưu thông tin người dùng với ID: ", docRef.id);
    }
