...
import {
  ROLE_ENUM,
  RoleFormBuilderDialogPropType,
} from "../../../src/models/RolesDTO";
...
export default function RoleFormBuilderDialog(
  props: RoleFormBuilderDialogPropType
) {
            ...
            <Controller
              ...
              render={({ field }) => {
                return (
                  <FormControl
                    sx={{ m: 1, minWidth: 120 }}
                    error={Object.hasOwn(errors, "value")}
                  >
