...
import {
  ChannelDataModel,
  ChannelPayloadModel,
} from "../../src/models/ChannelsDTO";
const FieldValue = FirebaseAdmin.firestore.FieldValue;

export const firestorePostCreateAChannel = async (
  channelPayload: ChannelPayloadModel
) => {
  const customPayload = {
    ...channelPayload,
...
export const firestoreUpdateChannelById = async (
  channelId: string,
  payload: ChannelDataModel
) => {
